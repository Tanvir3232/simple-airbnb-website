            ...
            {openSearchBox &&
                <div>
                    ...
                    <div className=' flex items-center mt-5 gap-2 border-2 p-2 rounded-full'>
                        <ul className='flex items-center gap-2 divide-x-2 '>
                            <li className="px-5 rounded-full " >
                                <label className='font-semibold' htmlFor="location">Where</label><br />
                                <input type="text" placeholder="Search destinations" className=" px-2 py-1 " />
                            </li>
                            <li className='pl-2 font-semibold'>
                                <label className='font-semibold' htmlFor="location">Check in</label><br />
                                <input type="date" placeholder="Add dates" className=" px-2 py-1 " />
                            </li>
                            <li className='pl-2 font-semibold'>
                            ...
                            <div className="dropdown dropdown-end">
                                <label tabIndex={0} className="flex px-4">
                                    <div>
                                        Who <br />
                                        <span className="text-gray-300 ">Add guests</span>
                                    </div>
                                    <button className='pl-2 font-semibold  text-white rounded-full  bg-red-500 p-3 flex gap-2 items-center'><FaSearch className='w-5 h-5'></FaSearch>Search</button>
                                </label>
